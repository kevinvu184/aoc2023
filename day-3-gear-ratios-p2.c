...
void processIndex(int coord[2], int chars, char engine[][chars],
                  int indexes[][2], int values[], int *i1, int *i2, int *gear) {
  ...
  for (int i = 0; i < lines; ++i) {
    for (int j = 0; j < chars; ++j) {
      if (engine[i][j] == '*') {
        ...
        processIndex(n, chars, engine, indexes, values, &i1, &i2, &gear);
        ...
        processIndex(ne, chars, engine, indexes, values, &i1, &i2, &gear);
        ...
        processIndex(e, chars, engine, indexes, values, &i1, &i2, &gear);
        ...
        processIndex(es, chars, engine, indexes, values, &i1, &i2, &gear);
        ...
        processIndex(s, chars, engine, indexes, values, &i1, &i2, &gear);
        ...
        processIndex(sw, chars, engine, indexes, values, &i1, &i2, &gear);
        ...
        processIndex(w, chars, engine, indexes, values, &i1, &i2, &gear);
        ...
        processIndex(wn, chars, engine, indexes, values, &i1, &i2, &gear);
      }
    }
  }
  for (int i = 0; i < i2; ++i) {
